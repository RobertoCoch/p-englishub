  ...
  return (
    <nav className='w-screen bg-[#0B1138] h-15 flex justify-around items-center md:justify-between'>
         <div className='flex items-center gap-3 md:ml-10'>
          <button title='Menu' className='w-10 h-10 rounded-md text-white hover:bg-[#162474]'>
        ...
        <div className='flex gap-3 md:mr-10'>
          <button title='Perfil' className='w-10 h-10 bg-[#162474] rounded-md text-white hover:bg-[#3E55DA]'>
            <img src={User} alt="User" className='w-9 h-9 ml-0.5' />
          </button>
          <button title='Configuracion' className='w-10 h-10 bg-[#162474] rounded-md text-white hover:bg-[#3E55DA]'>
            <img src={Settings} alt=""  className='w-8 h-8 ml-1'/>
          </button>
          <button title='Cerrar Sesión' className='w-10 h-10 bg-[#162474] rounded-md text-white hover:bg-[#3E55DA]'>
